...
func (e *Entity) GetUniqueID() int          { return e.uniqueId }
func (e *Entity) AddTypeBit(bit int64)      { e.typeBits |= bit }
func (e *Entity) AddSystemBit(bit int64)    { e.systemBits |= bit }
func (e *Entity) RemoveSystemBit(bit int64) { e.typeBits &= ^bit }
func (e *Entity) RemoveTypeBit(bit int64)   { e.typeBits &= ^bit }
func (e *Entity) GetSystemBits() int64      { return e.systemBits }
func (e *Entity) GetTypeBits() int64        { return e.typeBits }
...
func (e *Entity) GetAllComponents() *ComponentBag { return e.entityManager.GetComponents(e) }

//Add a component to this entity.
func (e *Entity) AddComponent(c Component) { e.entityManager.AddComponent(e, c) }

//Removes the component from this entity.
func (e *Entity) RemoveComponent(c Component) { e.entityManager.RemoveComponent(e, c) }
...
func (e *Entity) IsActive() bool { return e.entityManager.IsActive(e.GetID()) }
...
func (e *Entity) Refresh() { e.world.RefreshEntity(e) }

// Delete this entity from the world.
func (e *Entity) Delete() { e.world.DeleteEntity(e) }

//Set the group of the entity. Same as World.setGroup().
func (e *Entity) SetGroup(group string) { e.world.GetGroupManager().Set(group, e) }

// Assign a tag to this entity. Same as World.setTag().
func (e *Entity) SetTag(tag string) { e.world.GetTagManager().Register(tag, e) }
